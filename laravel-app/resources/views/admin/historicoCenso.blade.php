    ...
    <div class="uk-panel uk-panel-box" style="background-color: #691c32;">
        ...
        <ul class="uk-nav uk-nav-side" style="font-size: 1.4vh; background-color: #be335a; margin: 4px 8px; padding: 16px;">
            ...
            @foreach($historial as $h)
                ...
                <article class="uk-comment-primary" role="comment" style="position: relative; margin-bottom: 80px; box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px;">
